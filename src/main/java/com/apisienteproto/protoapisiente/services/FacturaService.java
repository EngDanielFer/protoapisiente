...
public class FacturaService {
    ...
    public FacturaResponseDTO crearFactura(FacturaDTO facturaDTO) {
        log.info("Creando factura para cliente: {} {}",
        ...
        Factura factura = facturaRepository.findById(idFactura)
                .orElseThrow(() -> new RecursoNoEncontradoException("Error al recuperar la factura creada"));

        log.info("Factura creada con ID: {}", idFactura);
